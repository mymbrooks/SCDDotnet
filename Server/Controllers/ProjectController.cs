...
namespace Server.Controllers
{
    public class ProjectController : Controller
    {
        ...
        public string PreviewSolution(long projectid) {
            ...
            try {
                ...
                relativePath = "EntrustOrder/" + year + "/" + saveName + ".pdf";
                absolutePath = Path.Combine(dirPath, saveName + ".pdf");
        ...
        public string DownloadSolution(long projectid)
        {
            ResultModel<string> resultModel = new ResultModel<string>();
